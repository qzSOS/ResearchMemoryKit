...
- **Current best**: The CLI passes 19 tests; all templates carry non-empty gated contracts; wheel installation and metadata checks pass.
- **Active work**: Finish the local security, privacy, formatting, git, and remote CI audit for release `0.2.0`.
